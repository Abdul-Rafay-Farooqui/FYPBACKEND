...
let AttendanceController = class AttendanceController {
    ...
    find(studentId, cbsId, date) {
        if (studentId)
            return this.service.findByStudent(studentId);
        if (cbsId && date)
            return this.service.findByCbsAndDate(cbsId, date);
        return [];
    }
    createBulk(records) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AttendanceController.prototype, "createBulk", null);
__decorate([
    (0, common_1.Delete)(),
    __param(0, (0, common_1.Query)('cbs_id')),
