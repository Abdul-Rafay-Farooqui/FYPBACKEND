...
let SchedulesService = class SchedulesService {
    ...
    async findByInstitute(instituteId) {
        ...
        const instituteCBS = allCBS.filter(cbs => cbs.batch?.institute_id === instituteId ||
        ...
        if (cbsIds.length === 0)
            return [];
        return this.repo.find({
            where: { class_batch_section_id: (0, typeorm_2.In)(cbsIds) },
...
exports.SchedulesService = SchedulesService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.Schedule)),
    __param(1, (0, typeorm_1.InjectRepository)(entities_1.ClassBatchSection)),
